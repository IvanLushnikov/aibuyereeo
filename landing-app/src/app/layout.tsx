...
export const metadata: Metadata = {
  ...
  description:
    "ИИ‑бот подбирает коды КТРУ по 44‑ФЗ и 223‑ФЗ за секунды: чат, шаблоны ТЗ и проверка соответствия ОКПД2.",
  openGraph: {
  ...
  twitter: {
    ...
    description:
      "Секунды вместо часов: ИИ‑бот подбирает КТРУ и характеристики, проверяет ОКПД2.",
    images: ["/og-image.png"],
  },
  icons: {
    icon: "/favicon.ico",
