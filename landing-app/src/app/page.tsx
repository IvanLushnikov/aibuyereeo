...
const audience = [
  ...
  },
  {
    ...
    description:
      "Меньше рутины: бот уточнит детали и соберёт шаблон ТЗ.",
    icon: "🛠️",
  },
  {
    title: "Специалисты по закупкам",
    description:
      "Актуальные классификаторы, контроль соответствия ОКПД2 ↔ КТРУ и журнал проверок.",
    icon: "📊",
  },
];
...
const steps = [
  ...
  },
  {
    ...
    text: "Спросит критические параметры и проверит, ничего ли не упущено.",
  },
  {
...
const painSolutions = [
  ...
  {
    pain: "Рассчитываете НМЦК вручную",
