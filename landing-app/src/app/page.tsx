...
const steps = [
  { title: "Вводите описание или черновик ТЗ", text: "Например: «нужны мониторы 24″ для школы, 10 шт.»" },
  { title: "Сопоставление по ключевым словам и аналогам", text: "Анализ формулировок, характеристик и возможных аналогов." },
  { title: "Коды КТРУ и обязательные характеристики", text: "Подсветка обязательных параметров и уточнение недостающих." },
  { title: "Проверка рисков несоответствия", text: "Контроль корректности характеристик по КТРУ до подачи заявки." },
  { title: "Обоснование с ссылками и экспорт результата", text: "Формируем обоснование и даём экспорт для вложения в заявку." },
];

const painSolutions = [
  { pain: "Время уходит на поиск кода", solution: "Автоподбор по описанию и аналогам." },
  { pain: "Разрозненные ТЗ без обязательных характеристик", solution: "Шаблоны и контроль обязательных полей КТРУ." },
  { pain: "Несоответствие ОКПД2 ↔ КТРУ", solution: "Сквозная проверка связок и подсветка расхождений." },
  { pain: "Ошибки в обосновании", solution: "Ссылки на карточки классификаторов и прозрачная логика подбора." },
];
      ...
      <section className="relative grid gap-8 lg:grid-cols-[1.2fr_1fr] lg:items-center lg:gap-12">
        <div className="space-y-6">
          ...
          <h1 className="font-display text-4xl leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl">
            Точный подбор ОКПД2 и КТРУ для закупок — за минуты
          </h1>
          <p className="max-w-2xl text-lg leading-relaxed text-white/80">
            ИИ‑помощник для инициаторов: находит релевантные коды, собирает обязательные характеристики
            и проверяет соответствие 44‑ФЗ/223‑ФЗ.
          </p>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <button
              type="button"
              onClick={() => {
                trackEvent("cta_click", { location: "hero", button: "Подобрать код" });
                openChat();
              }}
        ...
        <div className="relative overflow-hidden rounded-2xl border-2 border-neo-electric/50 bg-gradient-to-br from-neo-electric/20 via-neo-glow/10 to-neo-sunrise/10 p-8 text-center shadow-[0_0_60px_rgba(0,231,255,0.3)] backdrop-blur-xl">
          ...
          <div className="relative space-y-4">
            ...
            <button
              type="button"
              onClick={() => {
                trackEvent("cta_click", { location: "faq_section", button: "Подобрать код" });
                openChat();
              }}
