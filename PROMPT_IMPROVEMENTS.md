...
2. **Извлеки наименование товара** из запроса пользователя. Например:
   ...
   - «Двухканальный активный Di-box Klark Teknik DN200 V2» → «звуковое оборудование» или «аудио оборудование»
   - «Микшерный пульт Yamaha MG16XU» → «микшер» или «звуковое оборудование»
   
   **Важно:** Если в запросе есть специфические модели/бренды (Klark Teknik, Yamaha, и т.д.) — убирай их, оставляй только тип оборудования
...
4.1. **Если ничего не нашел или результаты нерелевантные:**
   ...
   - Для специфического оборудования (Di-box, микшер, процессор и т.д.):
     * Di-box, DI-box → "звуковое оборудование" или "аудио оборудование"
     * Микшер, микшерный пульт → "микшер" или "звуковое оборудование"
     * Процессор эффектов → "звуковое оборудование" или "аудио процессор"
     * Усилитель → "усилитель звука" или "звуковое оборудование"
   - Сам перефразируй запрос пользователя до 3 вариантов и поищи их через `ktru_lookup_plain`
   - Если все равно не нашел - скажи: "Не удалось найти точный код. Попробуйте указать более общее название товара (например, 'звуковое оборудование', 'микшер', 'усилитель')."
